...
// Serial Port (DEBUG)
#if defined(PCBX12S) || defined(RADIO_TX16S) && !defined(ACCESS_TX16S)
...
#if !defined(ACCESS_TX16S) && defined(PCBX10) || PCBREV >= 13
...
#if defined(PCBX10) && defined(PCBREV_EXPRESS) || defined(ACCESS_TX16S)
