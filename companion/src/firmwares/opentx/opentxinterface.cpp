      ...
      case 1:
        switch (proto) {
          ...
          case PULSES_ACCESS_R9M:
            return IS_TARANIS_XLITE(board) || IS_TARANIS_X9LITE(board) || board == BOARD_TARANIS_X9DP_2019 || board == BOARD_X10_EXPRESS || board == BOARD_RADIOMASTER_TX16S || (IS_FAMILY_HORUS_OR_T16(board) && id.contains("internalaccess"));
